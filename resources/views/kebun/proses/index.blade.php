            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Data Proses Pembuahan Tanaman Anggrek Setelah Melakukan Persilangan</h3>
    ...
    $(function () {
      $("#example1").DataTable({
        ...
        "buttons": [
            ...
            {extend: 'pdf', title:'Data Proses Buah PT Sari Bumi Mulya',exportOptions: {
                columns: [0, 1, 2, 3, 4, 5],
                modifier: {
                    page: 'current'
                }
            }},
            {extend: 'excel', title: 'Data Proses Buah PT Sari Bumi Mulya',exportOptions: {
                columns: [0, 1, 2, 3, 4, 5],
                modifier: {
                    page: 'current'
                }
            }},
            {extend:'print',title: 'Data Proses Buah PT Sari Bumi Mulya',exportOptions: {
                columns: [0, 1, 2, 3, 4, 5],
                modifier: {
                    page: 'current'
                }
