        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Trans3</li>
            </ol>
          </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Data Trans 3</h3>
    ...
    $(function () {
      $("#example1").DataTable({
        ...
        "buttons": [
            ...
            {extend: 'pdf', title:'Data Trans 3 PT Sari Bumi Mulya'},
            {extend: 'excel', title: 'Data Trans 3 PT Sari Bumi Mulya'},
            {extend:'print',title: 'Data Trans 3 PT Sari Bumi Mulya'},
        ]
