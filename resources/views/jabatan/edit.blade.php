    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="card card-default">
                ...
                <!-- /.card-header -->
                <div class="card-body">
                    <form action="{{ url('jabatan/update', [$p->id_jabatan]) }}" method="post">
                        @csrf
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>Nama Jabatan</label>
                                    <input type="text" class="form-control" id="nj" name="nj" value="{{ $p->jabatan }}" required>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>Gaji Pokok</label>
                                    <input type="number" name="gp" id="gp" class="form-control" value="{{ $p->gaji_pokok }}" required>
                                </div>
                            </div>
                        </div>
