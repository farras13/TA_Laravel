                    ...
                    <div class="card-body">
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td> {{ $n }} </td>
                                    <td> {{ date('d-m-Y H:i', strtotime($d->tanggal_keluar)) }}</td>
                                    <td> {{ $d->asju }} </td>
                                    <td> {{ $d->nama }} </td>
                                    <td> {{ $d->jumlah }} </td>
                                    <td> {{ $d->keterangan }} </td>
    ...
    $(function () {
      $("#example1").DataTable({
        ...
        "buttons": [
            ...
            {extend: 'pdf', title:'Data Keluar PT Sari Bumi Mulya', exportOptions: {
                columns: [0, 1, 2, 3, 4, 5, 6],
                modifier: {
                    page: 'current'
                }
            }},
            {extend: 'excel', title: 'Data Keluar PT Sari Bumi Mulya', exportOptions: {
                columns: [0, 1, 2, 3, 4, 5, 6],
                modifier: {
                    page: 'current'
                }
            }},
            {extend:'print',title: 'Data Keluar PT Sari Bumi Mulya', exportOptions: {
                columns: [0, 1, 2, 3, 4, 5, 6],
                modifier: {
                    page: 'current'
                }
